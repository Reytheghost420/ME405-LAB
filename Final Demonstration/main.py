...
leftMotorTask  = task_motor(leftMotor,  leftEncoder,
                            ...
                            kp_share, ki_share, left_sp, mode_share, uL_effort_share, None)

rightMotorTask = task_motor(rightMotor, rightEncoder,
                            rightMotorGo, dataValues, timeValues,
                            kp_share, ki_share, right_sp, mode_share, None, uR_effort_share)
...
observerTask = task_observer(leftEncoder, rightEncoder, imu,
                             ...
                             Ts=0.05, r=0.03, Vsup=6.0, ENC_CPR=1440, log_enable_share=log_enable)
...
# -------------------------------
# AUTO STRAIGHT TEST (TEMPORARY)
# -------------------------------
mode_share.put(0)        # 0 = normal / not line-follow
base_sp.put(100.0)       # cps (optional)
left_sp.put(100.0)       # cps
right_sp.put(100.0)      # cps
