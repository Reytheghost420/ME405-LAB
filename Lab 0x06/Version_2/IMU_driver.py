...
#   - Do NOT run test loops inside this module (scheduler will break).
...
class IMU_driver:
    ...
    def __init__(self, i2c_bus=1, baudrate=100_000, address=DEV_ADDR):
        ...
        # Default to IMU mode (good for yaw + gyro; switch if your lab requires NDOF)
    ...
    def write_calibration_data(self, calib_bytes):
        ...
        # Return to IMU mode by default (change if you want NDOF)
        self.set_mode(self.IMU_MODE)